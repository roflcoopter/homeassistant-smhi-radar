...
$.fn.calendar = function(options) {
	...
	function build(year, month, date) {
		...
		var daysRow = $('<tr></tr>');
		daysRow.append($('<td><span class="pad bold">Mån</span></td>'));
		daysRow.append($('<td><span class="pad bold">Tis</span></td>'));
		daysRow.append($('<td><span class="pad bold">Ons</span></td>'));
		daysRow.append($('<td><span class="pad bold">Tor</span></td>'));
		daysRow.append($('<td><span class="pad bold">Fre</span></td>'));
		daysRow.append($('<td><span class="pad bold">Lör</span></td>'));
		daysRow.append($('<td><span class="pad bold">Sön</span></td>'));
